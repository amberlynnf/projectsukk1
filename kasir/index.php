    ...
    <form action="proses_toko.php" method="POST">
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <?php $nama_barang = array("pasta gigi", "sabun", "air mineral");?>
            ...
            <tr>
                <td>Harga</td>
                <td>:</td>
                <td><input type="number" name="harga" placeholder="masukan harga barang" require=""></td>
            </tr>
            <tr>
                <td>jumlah</td>
                <td>:</td>
                <td><input type="number" name="jumlah" placeholder="masukan jumlah barang" require="" min="1"></td>
            </tr>
            <tr>
